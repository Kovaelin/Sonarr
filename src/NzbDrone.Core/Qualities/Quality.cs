...
namespace NzbDrone.Core.Qualities
{
    public class Quality : IEmbeddedDocument, IEquatable<Quality>
    {
        ...
        public static Quality Bluray1080pRemux => new Quality(20,  "Bluray-1080p Remux", QualitySource.Bluray, 1080);
        public static Quality Bluray2160pRemux => new Quality(21, "Bluray-2160p Remux", QualitySource.Bluray, 2160);
